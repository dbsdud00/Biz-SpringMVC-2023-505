 ...
 *  실제 호출될때는 두개가 연결 Mapping 으로 사용한다.
 *  
 */
...
public class UserController {
	...
	// RequestMapping 이 빠지면 value="/user/login"으로 작성
	@RequestMapping(value="/login" , method= RequestMethod.GET) 
	public String login(@RequestParam(name="ERROR", required = false) String error, @ModelAttribute("USER") UserDto userDto, Model model) { // 매개변수 대문자 소문자 확인 요망 
	...
	@ModelAttribute("USER") // session이 하나 만들어서 가지고 있음
	public UserDto userDto() { // 비어있는 UserDto 를 만들때
