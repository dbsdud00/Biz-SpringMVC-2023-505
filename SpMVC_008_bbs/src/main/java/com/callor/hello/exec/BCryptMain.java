...
//		}
		...
		// planText 를 암호화 시키는 method
		String encString = pbe.encrypt("yoooy");
		System.out.println(encString);
		
		String s1 = "I567/S5y3neClKSnbnV2Og==";
		String s2 = "o489qHJAoaTqPStmkKFQKw==;";
		String s3 = "hhotauKdqx56xKXquxcmAA==";
