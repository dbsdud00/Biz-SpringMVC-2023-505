...
public class BookController {
	...
	public String home(@RequestParam(name="page", required=false, defaultValue="1") 
	String page, @RequestParam(name="search", required=false, defaultValue="-1") 
...
//		model.addAttribute("BOOKS",books);
	...
	public String paramTest( @RequestParam(
			name="num",		
			required=false,			// 안보내도 상관없음
			defaultValue="0")		// 없으면 기본값 0으로 채워달라
			int num) {
