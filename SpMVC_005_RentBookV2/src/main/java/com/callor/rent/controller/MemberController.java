...
public class MemberController {
	...
	public List<MemberDto> mNameSearch( @RequestParam(name="m_name", required = false, defaultValue = "-1") String mname) {
		if(mname.equals("-1")) return null;
		log.debug("받은 멤버 {} ",mname);
